...
--  Based on Chandigarh University (CU), Mohali, Punjab
--  Enhanced version with real-world data and extended queries
-- ============================================================


-- ============================================================
--  TABLE DEFINITIONS (Original Schema - Unchanged)
-- ============================================================
...
-- ============================================================
--  SEED DATA: Chandigarh University Students
--  CU offers BBA, BCA, B.Tech, MCA, M.Sc and many more programs
--  These are fictional student names in CU style
-- ============================================================
...
-- ADDED: 10 more CU-style students across popular CU programs
...
-- ============================================================
--  SEED DATA: Hostel Rooms
--  CU hostels (e.g., A-Block, B-Block) have rooms of varying size
-- ============================================================
...
-- ADDED: 7 more rooms to accommodate extra students
...
-- ============================================================
--  SEED DATA: Room Allocations
--  Original 3 + 10 more realistic CU hostel allocations
-- ============================================================
...
-- ADDED: Allocations for new students
INSERT INTO allocation (student_id, room_id)
VALUES
...
--  ADDED: 10 realistic hostel complaints from CU students
--  (No complaints existed in the original schema data)
-- ============================================================
...
-- ============================================================
--  ORIGINAL QUERIES (from base project - kept as-is)
-- ============================================================
...
-- ============================================================
--  ADDED: SELECT QUERIES (Projection & Filtering)
-- ============================================================
...
-- ============================================================
--  ADDED: UPDATE QUERIES (Status changes, corrections)
-- ============================================================
...
-- ============================================================
--  ADDED: DELETE QUERIES (Deallocation, cancellation)
-- ============================================================
...
-- ============================================================
--  ADDED: AGGREGATE / ANALYTICAL QUERIES
-- ============================================================
